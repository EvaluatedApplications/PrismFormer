...
show the property and simulate the coupling in a single process here, not a live multi-node run. In that
single-process setting skill does spread without a coordinator: independently-initialised nodes share
what they have learned through continuous weight coupling, near-losslessly with the shared codec ($99\%$
versus $75\%$ cross-init transfer).
