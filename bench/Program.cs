...
if (args.Contains("--capacity")) { CapacityBench.Run(maxN: maxNArg ?? 1024, passes: stepsArg ?? 400, tuned: true); return; }   // atomic capacity: equal-sized transformer vs PrismFormer memorise the most unique arbitrary key→value facts (recall-vs-N)
