...
if (args.Contains("--lrsweep")) { LrSweepBench.Run(epochs: stepsArg ?? 5); return; }   // what LR actually works for the real L32/d256/S64 shape on corpus next-token? sweep current->ridiculous (3.0), map where it breaks
